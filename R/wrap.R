wrap <- function(data, metadata) {
	...
	for (i in 2:nouts) {
		...
		} else if (Best.Model[i] == 5.1 && Model1.c.Info$uruns[i] == FALSE) { Results[i, ] = Results.1c[i, ]
		} else if (Best.Model[i] == 5.1 && Model1.c.Info$uruns[i] == TRUE) { Results[i, ] = Results.1[i, ]
		} else if (Best.Model[i] == 5.2 && Model2.c.Info$uruns[i] == FALSE) { Results[i, ] = Results.2c[i, ]
		} else if (Best.Model[i] == 5.2 && Model2.c.Info$uruns[i] == TRUE) { Results[i, ] = Results.2c[i, ]
		} else if (Best.Model[i] == 5.3 && Model3.c.Info$uruns[i] == FALSE) { Results[i, ] = Results.3c[i, ]
		} else if (Best.Model[i] == 5.3 && Model3.c.Info$uruns[i] == TRUE) { Results[i, ] = Results.3c[i, ]
		} else if (Best.Model[i] == 5.4 && Model4.c.Info$uruns[i] == FALSE) { Results[i, ] = Results.4c[i, ]
		} else if (Best.Model[i] == 5.4 && Model4.c.Info$uruns[i] == TRUE) { Results[i, ] = Results.4c[i, ]
		} else if (Best.Model[i] == 5.41 && Model4.1.c.Info$uruns[i] == FALSE) { Results[i, ] = Results.4.1c[i, ]
		} else if (Best.Model[i] == 5.41 && Model4.1.c.Info$uruns[i] == TRUE) { Results[i, ] = Results.4.1c[i, ]
		} else if (Best.Model[i] == 5.42 && Model4.2.c.Info$uruns[i] == FALSE) { Results[i, ] = Results.4.2c[i, ]
		} else if (Best.Model[i] == 5.42 && Model4.2.c.Info$uruns[i] == TRUE) { Results[i, ] = Results.4.2c[i, ]
		}
	}	
